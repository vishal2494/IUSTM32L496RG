/*
Code to pin configuration for stm32l496rg.
...
const PinMap PinMap_PWM[] = {
  ...
  {PC_10,  TIM8,   STM_PIN_DATA_EXT(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF3_TIM8, 4, 0)},
  {NC,    NP,    0}
};
#endif
...
const PinMap PinMap_UART_RX[] = {
  ...
  {PC_5,  USART3,  STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF7_USART3)}, ///EDITED BY CHANDU
  {NC,    NP,    0}
};
#endif
